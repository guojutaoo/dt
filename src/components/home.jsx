        ...
        <div className="band">
          <div className="item-1">
            ...
            >
              <div
                className="thumb"
                style={{backgroundImage: "url("+ require('./images/starry-sky-theme.jpg') +")"}}
              />
              <article>
          ...
          <div className="item-2">
            ...
            >
              <div
                className="thumb"
                style={{backgroundImage: "url("+ require('./images/attack-titan-theme.jpg') +")"}}
              />
              <article>
          ...
          <div className="item-3">
            ...
            >
              <div
                className="thumb"
                style={{backgroundImage: "url("+ require('./images/avengers-endgame-theme.jpg') +")"}}
              />
              <article>
          ...
          <div className="item-4">
            ...
            >
              <div
                className="thumb"
                style={{backgroundImage: "url("+ require('./images/cityscapes-dual-theme.jpg') +")"}}
              />
              <article>
          ...
          <div className="item-5">
            ...
            >
              <div
                className="thumb"
                style={{backgroundImage: "url("+ require('./images/harry-potter-and-deathly-hallows-theme-2.jpg') +")"}}
              />
              <article>
                <h1>
          ...
          <div className="item-6">
            ...
            >
              <div
                className="thumb"
                style={{backgroundImage: "url(https://s3-us-west-2.amazonaws.com/s.cdpn.io/210284/flex-1.jpg)"}}             />
              <article>
                <h1>
          ...
          <div className="item-7">
            ...
            >
              <div
                className="thumb"
                style={{backgroundImage: "url("+ require('./images/dark-fantasy-landscape-theme.jpg') +")"}}              />
              <article>
                <h1>
